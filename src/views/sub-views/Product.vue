<template>
  <div
    class="grid grid-cols-1 md:grid-cols-2 mt-6 md:mt-0 px-6 gap-14 md:gap-10 items-center"
  >
    <div
    ...
    <div
      class="flex flex-col h-[82vh] text-lg justify-center pt-5 md:gap-10 gap-5 ml-2"
    >
      <div
        class="text-[#fa0] font-bold tracking-wider text-3xl md:text-4xl text-center md:text-start"
      >
        {{ product.title }}
      </div>

      <div
        class="flex flex-col-reverse md:flex-row md:justify-start md:gap-14 gap-4 items-center"
      >
        <div class="flex justify-center items-center md:justify-start gap-4">
          ...
          <div class="flex items-center">
            ...
            <button
              class="bg-gray-300 cursor-pointer hover:bg-gray-400 smooth text-gray-800 font-bold py-2 px-4 rounded-r focus:outline-none"
        ...
        <div
          class="text-2xl md:text-3xl text-gray-600 tracking-wider font-bold"
        >
          {{ product.price }}$
        </div>
      </div>
